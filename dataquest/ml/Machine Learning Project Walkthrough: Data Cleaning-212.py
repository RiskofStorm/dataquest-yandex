...
loans_2007.drop(['total_rec_int','total_rec_late_fee', 'recoveries','collection_recovery_fee','last_pymnt_amnt','last_pymnt_d'],axis=1,inplace=True)
...
loans_2007.drop(loans_2007[~((loans_2007['loan_status']=="Fully Paid") | (loans_2007['loan_status']=="Charged Off"))].index,inplace=True)
loans_2007.replace({
    "loan_status":{
        "Fully Paid":1,
        "Charged Off":0,
...
drop_columns = [i for i in loans_2007.columns if len(loans_2007[i].dropna().unique()) <= 1]
