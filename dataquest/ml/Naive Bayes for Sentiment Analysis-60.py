...
x = "Negative text sample: {0}".format(negative_text[:100])
y = "Positive text sample: {0}".format(positive_text[:100])
print(x,"\n",y)
...
var = "AUC of the predictions: {0}".format(metrics.auc(fpr, tpr))
print(var)
