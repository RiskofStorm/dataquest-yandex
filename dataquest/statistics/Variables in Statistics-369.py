...
nominal_scale = sorted(list(wnba.select_dtypes(include=['object']).columns.drop(["Experience", "Height_labels","Birthdate"])))
...
print(wnba['BMI'].value_counts(bins=5))


bmi = {21.200991370000001: [21.024, 23.657],
 21.329437550000002: [21.024, 23.657],
 23.875432530000001: [23.657, 26.29],
 24.543462380000001: [23.657, 26.29],
 25.46938776: [23.657, 26.29]}
